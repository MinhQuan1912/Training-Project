    ...
    <div class="product-overview">
      <div class="w-full flex justify-between h-12">
        ...
        <div class="flex gap-1">
          <div
            class="px-6 py-4.25 text-secondary font-semibold text-sm leading-[100%]"
          >
            1D
          </div>
          <div
    ...
    <div class="flex gap-3 w-full">
      ...
      <div class="product-overview !gap-4 flex-1">
        <div class="flex items-center justify-between h-12">
          <h6
            class="px-5 flex items-center text-xl leading-[145%] font-semibold text-primary"
          >
            Product activity
          </h6>
          <div
        ...
        <div class="px-5 pt-4">
          <div
            class="flex gap-6 py-5 text-xs leading-[160%] text-tertiary w-full"
          >
            <div class="flex-1">Week</div>
            <div class="flex-1">Products</div>
            <div class="flex-1">Views</div>
            <div class="flex-1">Likes</div>
            <div class="flex-1">Comments</div>
          </div>
          <div
            v-for="(item, idx) in productActivityList"
            :key="idx"
      ...
      <!-- Product Views -->
      <div class="product-overview !gap-3 w-135">
        <h6
