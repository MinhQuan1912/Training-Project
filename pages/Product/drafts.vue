  ...
  <div class="container">
    <div class="overflow-hidden border-cus-4">
      <div class="w-full flex justify-between items-center py-3 px-3 gap-3">
        ...
        >
          <h2
            class="text-primary text-6 leading-[145%] tracking-[0.06px] xs:pl-5 pt-2 xs:pt-0"
          >
            Products
          </h2>
          <UInput
      ...
      <div v-if="layout === 'list'">
        ...
        >
          ...
          <template #column-price="{ item }">
            ...
            <div
              class="text-sm text-secondary flex gap-3 items-center duration-100 cursor-pointer"
            >
              <div
                class="flex items-center gap-1 hover:text-white transition-colors duration-250 ease"
  ...
  >
    <form class="flex gap-x-4 gap-y-4 flex-wrap" v-if="editProduct">
      <div class="flex flex-col gap-1 xs:gap-2 w-full">
        ...
        <input
          type="text"
          class="!border border-black rounded-xl p-2 text-sm xs:text-xl h-8 xs:h-12"
