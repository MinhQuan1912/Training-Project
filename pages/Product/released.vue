  ...
  <div class="container overflow-hidden">
    ...
    <div class="mt-6 p-1">
      ...
      >
        ...
        >
          <tr class="rounded-[16px] p-4 hover:!bg-background-highlight">
            <th class="p-4 rounded-l-[16px]">
              <input
                type="checkbox"
                v-model="selectAll"
                @change="toggleAll"
                class="w-4 h-4 accent-green-500 flex items-center"
              />
            </th>
            <th class="p-4 text-left w-50 md:w-120">Product</th>
            <th class="p-4 text-left hidden md:table-cell">Status</th>
            <th class="p-4 text-left hidden sm:table-cell">Price</th>
            <th class="p-4 text-left hidden md:table-cell">Sales</th>
            <th class="p-4 text-left hidden sm:table-cell">Rating</th>
            <th class="p-4 text-left rounded-r-[16px] hidden lg:table-cell">
              Views
            </th>
          </tr>
        </thead>
        <tbody>
          <tr
            ...
            :key="index"
            class="rounded-[16px] outline outline-solid outline-transparent hover:outline-stroke-card-hover-dark hover:bg-background-highlight group"
            :class="{
            ...
            <td class="p-4 w-full min-w-65 md:w-120">
              <div class="flex items-center gap-3">
                ...
                <div class="w-full">
                  ...
                  <div
                    class="text-xs text-gray-400 block group-hover:hidden duration-100"
                  >
                    {{ item.description }}
                  </div>
                  <div
                    class="text-xs text-gray-400 hidden group-hover:flex gap-2 items-center duration-100 cursor-pointer"
                  >
                    <div
