<template>
    <div class="flex flex-col gap-3 w-full">
                    ...
                    <div class="flex gap-4">
                        <div class="flex flex-col max-w-41.5">
                            ...
                            <h2 class="flex text-[60px] font-medium leading-[125%] mb-3">
                                <span
                                    class="text-tertiary text-[32px] font-semibold leading-[145%] mr-2.5 pt-2">$</span>
                                {{ item.revenue }}
                            </h2>
                            <div class="flex gap-2 items-center">
                                <div class="max-w-19.5 flex gap-1 px-2 py-1.5 items-center rounded-lg border-[1.5px] border-[#ff6a5526] bg-[#ff6a550d] text-[#ff6a55]"
                                    :class="{
                                        '!bg-[#00a6560d] !border-[#00a65626] text-primary-02': item.increase
                                    }">
                                    <u-tooltip :delay-duration="0" :text="item.label">
                                        <icons-arrow2 class="!w-4 !h-4 rotate-135"
                                            :class="{ '!-rotate-45': item.increase }" />
                                    </u-tooltip>
        ...
        <div class="flex gap-3">
            <div class="product-overview !gap-4 w-252">
