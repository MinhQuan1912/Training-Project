<template>
  <div class="flex gap-2 md:gap-4 justify-start md:justify-between">
    ...
    <div class="hidden sm:flex justify-evenly items-center h-12 gap-3">
      <div
        class="w-50 md:w-60 lg:w-78.75 rounded-full bg-background-02 hidden md:flex items-center text-secondary"
      >
        <div class="p-3 pr-2">
          <icons-search />
        </div>
