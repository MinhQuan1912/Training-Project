<template>
  <div class="h-78 w-full rounded-4xl bg-black relative" :class="additionClass">
    <div
      v-if="!preview"
      class="flex items-center justify-center text-secondary group h-full"
    >
      <!-- Screen < 900px -->
      <div v-if="isTablet" class="w-full h-full">
        ...
        >
          <icons-upload
            class="w-16 h-16 group-hover:text-primary transition-all duration-300"
          />
          <span
            class="text-2xl group-hover:text-primary transition-all duration-300"
            >Upload Image</span
          >
          <input
            :id="imageId"
      ...
      >
        ...
        <div class="text-2xl text-center" :class="textClass">
    ...
    <div v-else class="w-full h-full">
      ...
      <button
        class="w-8 h-8 xs:w-12 xs:h-12 rounded-full bg-background-02 text-secondary absolute top-3 right-3 flex justify-center items-center cursor-pointer hover:text-background-02 hover:bg-white transition-all duration-300 ease"
