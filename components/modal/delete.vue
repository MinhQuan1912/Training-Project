            ...
            <div v-if="props.isOpen" class="fixed inset-0 flex items-center justify-center z-110"
                ...
                <div class="bg-white w-[80dvw] xs:w-110 md:w-150 rounded-2xl flex flex-col px-4">
                    ...
                    <div class="p-4 py-2 flex justify-end items-center gap-4">
                        ...
                        cursor-pointer text-xl font-semibold hover:text-primary active:text-primary hover:bg-[#ff6a55] active:bg-[#ff6a55] transition-colors duration-200 ease">
                            Cancel
                        </button>
                        ...
                        cursor-pointer text-xl font-semibold hover:text-primary active:text-primary hover:bg-primary-02 active:bg-primary-02 transition-colors duration-200 ease">
                            Confirm
                        </button>
                    </div>
                </div>
